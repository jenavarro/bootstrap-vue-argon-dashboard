        ...
        <div class="header-body text-center mb-7">
          <b-row class="justify-content-center">
            <b-col xl="5" lg="6" md="8" class="px-5">
              ...
              <p class="text-lead text-white">Crear una cuenta de usuario para auto-servicio</p>
            </b-col>
          </b-row>
        </div>
      </b-container>
            ...
            <b-card-body class="px-lg-5 py-lg-5">
              ...
              <validation-observer v-slot="{handleSubmit}" ref="formValidator">
                <b-form role="form" @submit.prevent="handleSubmit(onSubmit)">
                  ...
                  <div class="text-muted font-italic"><small>Complejidad de la clave: <span
                    class="text-success font-weight-700">fuerte</span></small></div>
                  <b-row class=" my-4">
                    <b-col cols="12">
